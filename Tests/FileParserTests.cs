...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Path.GetFullPath(@"..\..\..\..\") + "/DataFiles/data.csv";
        private string _tsvPath = Path.GetFullPath(@"..\..\..\..\") + "/DataFiles/data.tsv";

        private string _writeFile = Path.GetFullPath(@"..\..\..\..\") + "/DataFiles/dataWrite.txt";
